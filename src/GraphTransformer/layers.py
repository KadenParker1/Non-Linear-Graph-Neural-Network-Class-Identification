...
class Attention(gnn.MessagePassing):
    ...
    def __init__(self, embed_dim, num_heads=8, dropout=0., bias=False,
        ...
        self.batch_first=False # I ADDED THIS
...
class StructureExtractor(nn.Module):
    """ K-subtree structure extractor. Computes the structure-aware node embeddings using the
...
class KHopStructureExtractor(nn.Module):
    """ K-subgraph structure extractor. Extracts a k-hop subgraph centered around

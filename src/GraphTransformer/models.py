...
class GraphTransformer(nn.Module):
    def __init__(self, in_size, d_model, num_class, num_heads=8,
                 dim_feedforward=32, dropout=0.0, num_layers=2,
                 batch_norm=False, abs_pe=False, abs_pe_dim=0,
                 gnn_type="gcn", se="gnn", use_edge_attr=False, num_edge_features=4,
                 in_embed=False, edge_embed=True, use_global_pool=False, max_seq_len=None,
